...
final class DependenciesRepository implements DependenciesRepositoryInterface
{
    ...
    public function getType(string $id)
    {
        ...
        throw new ContainerException(sprintf('Given alias:%s does\'t exist in container to determine type!', $id));
    }
    ...
    public function get(string $id)
    {
        ...
        if (!isset($mergedDependencies[$id])) {
            throw new ContainerException(sprintf('Given alias:%s does\'t exist in container to get instance!', $id));
        }
